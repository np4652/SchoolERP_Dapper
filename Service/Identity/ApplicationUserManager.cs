...
namespace Service.Identity
{
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            string sqlQuery = @"SELECT u.Id,u.UserName,u.RefreshToken,u.[Name], ar.[Name] as [Role], u.Email,u.PhoneNumber,u.gender ,
                                stuff((        
        ...
        {
            var user = await _dapperRepository.GetAsync<ApplicationUser>(@"Select u.Id,u.UserName,u.RefreshToken,u.[Name], ar.[Name] as [RoleId], u.Email from Users u(nolock) left join RoleId r(nolock) on r.UserId = u.Id left join ApplicationRole ar(nolock) on ar.Id = r.RoleId where u.UserId = @MerchantID and u.ConcurrencyStamp = @SecurityCode",
                new
                {
                    request.MerchantID,
